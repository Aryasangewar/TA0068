...
![DocuFlux UI](https://img.shields.io/badge/Aesthetic-Electric_Medical-6366f1?style=for-the-badge)
![AI Powered](https://img.shields.io/badge/Intelligence-Gemini_2.0_Flash-teal?style=for-the-badge)
![Privacy First](https://img.shields.io/badge/Privacy-End_Sub_End_Consent-emerald?style=for-the-badge)
...
- **AI Access**: An [OpenRouter](https://openrouter.ai/) API Key
...
### For Doctors
1. **Initialize Identity**: Ask the patient for their 6-character Short ID.
2. **Request Access**: Enter the ID to initiate a clinical handshake.
3. **Voice Scribe**: Start the recorder during the consultation. Once finished, click "Structure with Flow Engine".
4. **Finalize**: Review the AI-generated data, add resolution notes or upload an RX image, and mark the case as "Completed".

### For Patients
1. **Dashboard**: Log in to see your "Clinical Vault".
2. **Authorize**: Any pending requests from doctors will appear in your "Privacy Control" panel.
3. **Control Node**: Choose exactly which fields the doctor is allowed to see before clicking "Authorize Channel".

---

## 👤 Credits
**Design and Developed by Mohsin,Wasif,Furqan,Arya,Tamanna**
*Crafted for the future of digital health.*
